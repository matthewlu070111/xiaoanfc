...
public class SesameCustomBlock extends CropBlock {
    public static final MapCodec<SesameCustomBlock> CODEC = createCodec(SesameCustomBlock::new);
    ...
    public SesameCustomBlock(Settings settings) {
        super(settings);
    }
